...
private:
    ...
    bool activeBlending = false;
    float animBlendDur = -1.f;
    float previousTicksInSeconds = 0.f;
    double timeInSeconds = 0.0f;
    float totalAnimDur = 0.0f;
...
#define NUM_BONES_PER_VEREX 4
    ...
    void ReadNodeHeirarchy(const aiNode *pNode, const mat4 &ParentTransform, double AnimationTime, double AnimationTime_to, float blendFactor);
